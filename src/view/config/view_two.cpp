...
void view_two::init_info_systema()
{
    ...
    this->list_info_system[1]->set_text((Helper::System::exec(a.c_str())).empty() ? Helper::System::exec("cat /proc/device-tree/model") : Helper::System::exec(a.c_str()) + " " + Helper::System::exec(b.c_str()));
